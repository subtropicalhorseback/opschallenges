...
# cool little file selector function from prompt engineering w gpt
...
# open main function to crack open zipped files
...
def main_menu(): 
    while True:
        print("\nMenu:")
        print("1 - SSH Attempt / Brute Force")
        print("2 - Unlock Zip / Brute Force")
        print("3 - Quit - 'q' or 3")
