...
from logging import StreamHandler  # Add StreamHandler import
...
def main():
    ...
    stream_handler = StreamHandler()  # Create StreamHandler instance
    stream_handler.setFormatter(log_formatter)  # Apply formatter
    logger = logging.getLogger()  # Get the root logger
    logger.addHandler(stream_handler)  # Add the StreamHandler
